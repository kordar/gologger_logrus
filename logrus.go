...
func (s logrusAdapt) WithField(key string, value interface{}) logger.Logger {
...
func (s logrusAdapt) WithFields(fields logger.Fields) logger.Logger {
...
func (f fieldAdapt) WithField(key string, value interface{}) logger.Logger {
	return newFieldAdapt(f.e.WithField(key, value))
}

func (f fieldAdapt) WithFields(fields logger.Fields) logger.Logger {
...
func (f fieldAdapt) WithError(err error) logger.Logger {
...
func newFieldAdapt(e *logrus.Entry) logger.Logger {
	return fieldAdapt{e}
}

func NewLogrusAdapt(l *logrus.Logger) logger.Logger {
	return &logrusAdapt{
		l: l,
	}
}
